...
#+BEGIN_SRC sh
brew install wget emacs git irssi mutt offline-imap tmux keybase
#+END_SRC
...
#+BEGIN_SRC sh
brew cask install iterm2 alfred 1password dropbox dash shiftit bartender devonthink-pro-office racket
#+END_SRC
* Emacs
