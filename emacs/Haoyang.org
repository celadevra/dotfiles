      ...
      (use-package org-webpage :ensure t
        ...
        (owp/add-project-config
         '("expoundite.net"
           ...
           :ignore ("blog" "codex" "upload.org")
           :theme (worg)
           :default-category "essays"
           :source-browse-url ("GitHub" "https://github.com/celadevra/expoundite.net")
           :web-server-port 9999))
        (owp/add-project-config
         '("expoundite.net/blog"
           :repository-directory "~/org/websrc/blog"
           :remote (rclone "local" "/tmp/website/blog")
           :site-domain "https://expoundite.net/blog"
           :site-main-title "chmod +w Web"
           :site-sub-title "blog"
           :ignore ("rss.org")
           :theme (worg)
           :default-category "journal"
           :source-browse-url ("GitHub" "https://github.com/celadevra/expoundite.net/tree/master/blog")
           :web-server-port 9999))
        (owp/add-project-config
         '("expoundite.net/codex"
           :repository-directory "~/org/websrc/codex"
           :remote (rclone "local" "/tmp/website/codex")
           :site-domain "https://expoundite.net/codex"
           :site-main-title "chmod +w Web"
           :site-sub-title "codex"
           :theme (killjs worg)
           :default-category "entry"
           :source-browse-url ("GitHub" "https://github.com/celadevra/expoundite.net/blob/master/codex")
           :web-server-port 9999)))
    #+END_SRC
