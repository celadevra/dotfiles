...
** Find task file
   ...
   #+BEGIN_SRC emacs-lisp
     (defun find-task-file () (interactive)
            "Find task file"
            (find-file "~/Codes/org/tasks.org"))
   #+END_SRC
** Find notes file
   #+BEGIN_SRC emacs-lisp
     (defun find-notes-file () (interactive)
            "Find notes file"
            (find-file "~/Codes/org/notes.org"))
   #+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (setq org-todo-keywords
        '((sequence "NEW(n)" "WORKING(w)" "WAITING(i@/!)" "|" "DONE(d)" "CANCELLED(c@)")))
  ...
  (setq org-capture-templates
   '(("t" "Task" entry (file+headline org-default-notes-file "Inbox")
     ...
     ("j" "Journal" entry (file+datetree "~/codes/org/Chronological.org")
      "* %?\nEntered on %U\n %a")
     ("s" "Snippet" entry (file "~/codes/org/notes.org")
     "* %^{Title} %^g\n %U \n %^C \n %?")))
#+END_SRC
** Code blocks
