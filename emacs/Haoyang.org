...
** Publishing
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (setq org-publish-project-alist
           '(("expoundite.net" :components ("essays"
                                          ...
                                          "rss"
                                          "gallery"))
           ("essays" :base-directory "~/org/publishing/essays"
            :publishing-directory "~/org/published"
	    :base-extension "page\\|org"
            :html-postamble t
            :recursive t
            :auto-sitemap t
            :html-doctype "html5"
           ...
           ("assets" :base-directory "~/org/publishing/assets"
            ...
            :recursive t)
           ("docs" :base-directory "~/org/publishing/docs"
            :publishing-directory "~/org/published/docs"
            :recursive t
            :base-extension any
            :html-postamble t
            :html-doctype "html5"
	    ...
	    :with-toc nil
            ...
            :publishing-function org-html-publish-to-html)
           ("movies" :base-directory "~/org/publishing/movies"
            :publishing-directory "~/org/published/movies"
            :recursive t
            :html-postamble t
            :html-doctype "html5"
            :with-drawers t
            :publishing-function org-html-publish-to-html)
           ("books" :base-directory "~/org/publishing/books"
            :publishing-directory "~/org/published/books"
            :recursive t
            :html-postamble t
            :html-doctype "html5"
            :with-drawers t
            :publishing-function org-html-publish-to-html)
           ("tv" :base-directory "~/org/publishing/tv"
            :publishing-directory "~/org/published/tv"
            :recursive t
            :html-postamble t
            :html-doctype "html5"
            :with-drawers t
	    ...
	    :include ("rss.org")
           ...
           ("gallery" :base-directory "~/org/publishing/gallery"
            :publishing-directory "~/org/published/gallery"
            :html-doctype "html5"
            :html-postamble t
            :recursive t
            :publishing-function org-html-publish-to-html)
   ...
   #+BEGIN_SRC emacs-lisp
          (setq org-html-postamble-format
                '(("en" "<footer><hr>Created by <span class=\"author\">%a (%e) on %d</span> <br>under <a href=\"https://creativecommons.org/licenses/by-sa/4.0/\">CC-BY-SA 4.0</a><p>Last Modified at %C</p></footer>")))
          ...
          (setq org-html-preamble-format
                '(("en" "<nav><ul>
                  ...
                  <li><a href=\"/blog/rss\">Blog</a></li>
                  <li><a href=\"https://github.com/celadevra\">GitHub</a></li>
                  <li><a href=\"https://twitter.com/celadevra\">Twitter</a></li>
                  </ul>
                  </nav>")))
